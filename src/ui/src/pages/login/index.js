        ...
        <Box className={styles.container}>
            <Box className={styles.brandSection}>
                ...
                <Typography className={styles.brandSubtitle}>
                    Experience the next generation of deployment pipelines. Fast, secure, and incredibly beautiful.
                </Typography>
            </Box>
            
            <Box className={styles.formContainer}>
                <form className={styles.form} onSubmit={onSubmit} noValidate>
                    <Typography variant="h2" className={styles.title}>Welcome back</Typography>
                    ...
                    <div className={styles.signUpRow}>
                        Don't have an account? <NavLink to={'/register'} className={styles.link}>Sign up</NavLink>
                    </div>
                </form>
            </Box>
        </Box>
